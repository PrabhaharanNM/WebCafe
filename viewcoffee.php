...
<body>
    ...
    <div class="container my-4" id="cont">
        ...
        ?>
        <script> document.getElementById("title").innerHTML = "<?php echo $coffeeName; ?>"; </script> 
        <?php
        echo  '<div class="col-md-4">
                <img src="img/coffee-'.$coffeeId. '.jpg" width="249px" height="262px">
            </div>
            <div class="col-md-8 my-4">
                <h3>' . $coffeeName . '</h3>
                <h5 style="color: #ff0000">Rs. '.$coffeePrice. '/-</h5>
                <p class="mb-0">' .$coffeeDesc .'</p>';
                ...
                if($loggedin){
                    ...
                    if($quaExistRows == 0) {
                        echo '<form action="OnlineCoffeeDelivery/partials/_manageCart.php" method="POST">
                ...
                <div class="mx-4">
                    <a href="viewcoffeeList.php?catid=' . $coffeeCategorieId . '" class="active text-dark">
